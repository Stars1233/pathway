...
def read(
    ...
    **kwargs,
    ...
    The Pathway Live Data Framework will use the given stream to read data.

    You can also use your own durable JetStream pull consumer if you already have one.
    To do this, specify the ``durable_consumer_name`` parameter. Otherwise, the Pathway Live Data Framework will
    ...
    Args:
        ...
        parallel_readers: The number of reader instances running in parallel. If not
            ...
            can't exceed the number of Pathway Live Data Framework engine threads and will be reduced if
            necessary.
    ...
    stream the ``"data"`` topic to a Pathway Live Data Framework table like this:
    ...
    if you restart your Pathway Live Data Framework program, this configuration will only read the new messages
...
def write(
    ...
    *,
    ...
    to ensure that the Pathway Live Data Framework writes to the correct persistent stream.
    ...
    sort_by = remap_sort_by(sort_by, table, output_format.table, "pw.io.nats.write")
